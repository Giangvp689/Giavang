...
export const TV_THEMES: TvThemeDefinition[] = [
  ...
  {
    id: 'spring',
    name: 'Mùa Xuân & Én Lượn',
    seasonName: 'Xuân Đâm Chồi • Vạn Vật Sinh Sôi',
    subtitle: 'Đàn én mùa xuân chao liệng, hoa mai hoa đào phơi phới',
    icon: '🌿',
    ...
    tagline: 'Đàn én sải cánh chao liệng & cánh hoa xuân phấp phới',
    description: 'Đàn én mùa xuân tung cánh chao lượn rộn ràng trên bầu trời xanh ngọc, cánh hoa đào thắm và lộc non đâm chồi mang biểu tượng sinh sôi phát tài cho tiệm vàng.',
    effectDescription: 'Đàn én sải cánh chao lượn, cánh hoa xuân & chồi non rộn ràng'
  },
  {
    id: 'summer',
